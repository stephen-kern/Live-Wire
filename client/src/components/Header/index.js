    ...
    <div className="container">
      ...
      <div>
        <p>
            ...
            and create "Reviews" of your favorite tracks, records, artists, shows, and more. View other users
            Reviews and leave a comment! You can also add Bandmates and see what the buzz is!
        </p>
      </div>
    </div>
    </>
